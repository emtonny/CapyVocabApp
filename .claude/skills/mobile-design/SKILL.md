...
Use the available Python interpreter for the current operating system. Execute
the audit script for relevant mobile implementation or review tasks:
...
Read `mobile-design-thinking.md` first for mobile design tasks. Then load only
the references required by the task and target platforms.

### Core References

| File | Load when |
|------|-----------|
| **[mobile-design-thinking.md](mobile-design-thinking.md)** | Always for mobile design or implementation decisions |
| **[touch-psychology.md](touch-psychology.md)** | Designing or reviewing interactions, gestures, controls, or accessibility |
| **[mobile-performance.md](mobile-performance.md)** | Implementing or diagnosing rendering, memory, startup, lists, or battery usage |
| **[mobile-backend.md](mobile-backend.md)** | Working with APIs, offline behavior, synchronization, or push notifications |
| **[mobile-testing.md](mobile-testing.md)** | Planning, writing, or reviewing tests |
| **[mobile-debugging.md](mobile-debugging.md)** | Investigating failures or platform-specific defects |
| [mobile-navigation.md](mobile-navigation.md) | Working on navigation or deep links |
| [mobile-typography.md](mobile-typography.md) | Working on text, scaling, localization, or accessibility |
| [mobile-color-system.md](mobile-color-system.md) | Working on themes, contrast, dark mode, or OLED behavior |
| [decision-trees.md](decision-trees.md) | Selecting a framework, state management, storage, or architecture |
...
| **Cross-Platform** | Both above | Platform divergence points | React Native / Flutter targeting both platforms |

Read the platform reference for each platform actually in scope. For
cross-platform work targeting both iOS and Android, read both and apply
...
### Ask Only When Not Specified or Discoverable

First inspect the task and relevant repository configuration. Ask only when the
answer is neither stated by the user nor reliably discoverable from project
context, and when the choice materially affects the result.
