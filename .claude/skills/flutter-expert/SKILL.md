---
name: flutter-expert
description: Expert Flutter and Dart guidance for architecture, widgets, state management, performance, testing, platform integration, accessibility, and multi-platform deployment. Use for implementing, debugging, reviewing, optimizing, or designing Flutter applications.
---
