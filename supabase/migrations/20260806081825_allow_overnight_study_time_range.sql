...
BEGIN
    ...
    -- Cho phep khung gio qua dem (vd 22:00 -> 02:00). Chi chan truong
    -- hop gio bat dau = gio ket thuc (khoang thoi gian = 0 hoac 24h,
    -- vo nghia). Khong con bat buoc end > start theo kieu so sanh
    -- gio thuong - da support wraparound qua nua dem.
